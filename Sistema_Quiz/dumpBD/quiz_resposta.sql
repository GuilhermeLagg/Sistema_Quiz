...
CREATE TABLE `resposta` (
  ...
  KEY `fk_alternativa` (`id_alternativa`),
  CONSTRAINT `fk_alternativa` FOREIGN KEY (`id_alternativa`) REFERENCES `alternativa` (`id_alternativa`),
  CONSTRAINT `fk_resposta` FOREIGN KEY (`id_pergunta`) REFERENCES `pergunta` (`id_pergunta`),
  CONSTRAINT `resposta_ibfk_1` FOREIGN KEY (`id_partida`) REFERENCES `partida` (`id_partida`)
